        ...
        const handleSubmit=e=>{
            ...
            .then(data=>{
                if(data.error){
                    ...
                    setValues({...values,product_name:'',product_price:'',product_description:'',
                countInStock:'',product_image:'',success:true,error:''})
                }
            })
        }
             //to show error msg
                ...
                <div className="col-md-6 mt-4">
                 <form className="shadow-lg p-3">
                     ...
                     <div className="mb-3">
                         ...
                         <input type="text" id="stock" className="form-control"
                     ...
                     <div className="mb-3">
                         ...
                         onChange={handleChange('product_image')}></input>
                     </div>
                     <div className="mb-3">
