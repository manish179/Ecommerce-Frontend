            ...
            <div className="row d-flex justify-content-between mt-5 mb-3">
              ...
              <div className="col-md-8 shadow">
                {cartItems.map((item, i) => (
                  <Fragment key={i}>
                    ...
                    <div className="col-1">
                      <button className="btn btn-danger" onClick={()=>removeCartHandler(item.product,item.name)}>
              ...
              <div className="col-md-3">
                <div className="shadow p-2">
                  ...
                  <hr />
                  <span>
                    <b>Units:</b> {cartItems.reduce((ac,item)=>(ac+Number(item.quantity)),0)} (Units)
                  </span>
                  <br />
                  <span>
                    <b>Total:</b> Rs.{cartItems.reduce((ac,item)=>(ac+item.quantity*item.price),0)}
                  </span>
                  <hr />
